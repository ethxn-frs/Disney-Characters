//
//  CharacterTvShowCollectionViewCell.swift
//  Disney Characters
//
...
class CharacterTvShowCollectionViewCell: UICollectionViewCell {
 
    static let cellIdentifier = "CharacterTvShowCollectionViewCell"
